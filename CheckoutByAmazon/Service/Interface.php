...
interface  CheckoutByAmazon_Service_Interface 
{
    ...
    *calculate Taxes and Shipping charges based on the address selected by the user 
   ...
   /** 
    * This function calls SetContractCharges API. You can use this API to set shipping, tax,
    ...
    * [Shipping + Tax] + No Promotion
    * [No Shipping + No Tax] + Promotion
